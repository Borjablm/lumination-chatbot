...
define( 'LUMINATION_CHATBOT_VERSION', '2.3.6' );
...
$lumination_chatbot_update_checker = PucFactory::buildUpdateChecker(
	'https://github.com/Borjablm/lumination-chatbot/',
	__FILE__,
	'lumination-chatbot'
);
$lumination_chatbot_update_checker->getVcsApi()->enableReleaseAssets();
